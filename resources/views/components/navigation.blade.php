...
<nav class="navbar navbar-expand-lg bg-white border-bottom sticky-top" style="border-top: 4px solid #FF6B6B; box-shadow: 0 12px 28px rgba(30, 58, 95, 0.08);">
    <div class="container-fluid ps-4 pe-4">
        ...
        <a class="navbar-brand fw-bold" href="{{ route('dashboard') }}" style="color: #1E3A5F; letter-spacing: 0.02em; font-size: 1.3rem;">
            <i class="bi bi-cpu me-2"></i>TechFlow
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            @auth
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    @can('viewAny', App\Models\CategoryAKL::class)
                        <li class="nav-item">
                    ...
                    @if(auth()->user()->role === 'admin')
                        <li class="nav-item">
                            <a class="nav-link fw-600 {{ request()->routeIs('users.index') || request()->routeIs('users.show') || request()->routeIs('users.edit') ? 'active' : '' }}" href="{{ route('users.index') }}" style="color: #42526b;">
